...
target("nimblefix-usagegen")
    set_kind("binary")
    add_deps("nimblefix")
    add_files("tools/usagegen/*.cpp")
...
target("nimblefix-msgdump")
    set_kind("binary")
    add_deps("nimblefix")
    add_files("tools/msgdump/*.cpp")

target("nimblefix-router")
    set_kind("binary")
    add_deps("nimblefix")
    add_files("tools/router/*.cpp")

target("nimblefix-schema-optimizer")
    set_kind("binary")
    add_deps("nimblefix")
    add_files("tools/schema-optimizer/*.cpp")
...
add_internal_repo_includedirs("nimblefix-usagegen")
...
add_internal_repo_includedirs("nimblefix-msgdump")
add_internal_repo_includedirs("nimblefix-router")
add_internal_repo_includedirs("nimblefix-schema-optimizer")
...
apply_local_dep("nimblefix-usagegen", "nimblefix-usagegen")
...
apply_local_dep("nimblefix-msgdump", "nimblefix-msgdump")
apply_local_dep("nimblefix-router", "nimblefix-router")
apply_local_dep("nimblefix-schema-optimizer", "nimblefix-schema-optimizer")
