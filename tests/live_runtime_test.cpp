...
public:
  ...
  auto TryPopEvent(std::uint32_t worker_id) -> fastfix::base::Result<std::optional<fastfix::runtime::RuntimeEvent>>
  {
...
public:
  ...
  auto OnRuntimeEvent(const fastfix::runtime::RuntimeEvent& event) -> fastfix::base::Status override
  {
    ...
    if (event.handle.session_id() != expected_session_id_) {
      return fastfix::base::Status::InvalidArgument("queue-decoupled application observed an unexpected session");
    }
                                  ...
                                  std::string default_appl_ver_id) -> fastfix::base::Status
{
  ...
  while (true) {
    ...
    if (!saw_heartbeat) {
      return fastfix::base::Status::InvalidArgument("live acceptor did not emit heartbeat before the long poll timeout "
                                                    "elapsed");
    }
...
TEST_CASE("live-runtime", "[live-runtime]")
{
  ...
  fastfix::runtime::LiveAcceptor runtime(&engine,
  ...
  REQUIRE(count_notifications(notifications_42.value(), fastfix::session::SessionNotificationKind::kSessionBound) ==
          1U);
  REQUIRE(count_notifications(notifications_42.value(), fastfix::session::SessionNotificationKind::kSessionActive) ==
          1U);
  REQUIRE(count_notifications(notifications_42.value(), fastfix::session::SessionNotificationKind::kSessionClosed) ==
          1U);
  REQUIRE(count_notifications(notifications_42.value(), fastfix::session::SessionNotificationKind::kAdminMessage) >=
          2U);
  REQUIRE(count_notifications(notifications_42.value(),
                              fastfix::session::SessionNotificationKind::kApplicationMessage) == 1U);
  REQUIRE(count_notifications(notifications_fixt.value(), fastfix::session::SessionNotificationKind::kSessionBound) ==
          1U);
  REQUIRE(count_notifications(notifications_fixt.value(), fastfix::session::SessionNotificationKind::kSessionActive) ==
          1U);
  REQUIRE(count_notifications(notifications_fixt.value(), fastfix::session::SessionNotificationKind::kSessionClosed) ==
          1U);
  REQUIRE(count_notifications(notifications_fixt.value(), fastfix::session::SessionNotificationKind::kAdminMessage) >=
          2U);
  ...
  fastfix::runtime::LiveAcceptor shard_runtime(&shard_engine,
                                               fastfix::runtime::LiveAcceptor::Options{
                                                 .poll_timeout = std::chrono::milliseconds(25),
                                                 .io_timeout = std::chrono::seconds(5),
  ...
  fastfix::runtime::LiveAcceptor balance_runtime(&balance_engine,
                                                 fastfix::runtime::LiveAcceptor::Options{
                                                   .poll_timeout = std::chrono::milliseconds(25),
                                                   .io_timeout = std::chrono::seconds(5),
                                                   .application = {},
  ...
  for (std::size_t index = 0U; index < 6U; ++index) {
    auto connection =
      fastfix::transport::TcpConnection::Connect("127.0.0.1", balance_port.value(), std::chrono::seconds(5));
  ...
  auto accept_count = [&balance_engine]() {
    ...
    return static_cast<std::size_t>(
      std::count_if(traces.begin(), traces.end(), [](const fastfix::runtime::TraceEvent& event) {
  ...
  auto trace_text = [](const fastfix::runtime::TraceEvent& event) { return std::string_view(event.text.data()); };
  ...
  fastfix::runtime::LiveAcceptor queue_mismatch_runtime(&queue_mismatch_engine,
                                                        fastfix::runtime::LiveAcceptor::Options{
  ...
  fastfix::runtime::LiveAcceptor threaded_runtime(&threaded_engine,
                                                  fastfix::runtime::LiveAcceptor::Options{
                                                    .poll_timeout = std::chrono::milliseconds(25),
                                                    .io_timeout = std::chrono::seconds(5),
  ...
  fastfix::runtime::LiveAcceptor timer_runtime(&timer_engine,
                                               fastfix::runtime::LiveAcceptor::Options{
...
TEST_CASE("dynamic session factory accepts unknown CompID", "[live-session-factory]")
{
  ...
  engine.SetSessionFactory(
    [&](const fastfix::session::SessionKey& key) -> fastfix::base::Result<fastfix::runtime::CounterpartyConfig> {
...
TEST_CASE("dynamic session factory rejects unknown CompID", "[live-session-factory]")
{
  ...
  engine.SetSessionFactory(
    [](const fastfix::session::SessionKey&) -> fastfix::base::Result<fastfix::runtime::CounterpartyConfig> {
