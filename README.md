...
| **FIX tagvalue encoding** | **Implemented** | Core codec, generated typed message APIs, fixed-layout writers, raw pass-through, SIMD-assisted tag/value parsing |
