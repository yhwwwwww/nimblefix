...
auto
ParseU32(std::string_view token) -> base::Result<std::uint32_t>
{
  try {
...
auto
ParseU64(std::string_view token) -> base::Result<std::uint64_t>
{
  try {
...
auto
ParseValueType(std::string_view token) -> base::Result<ValueType>
{
...
auto
ParseFieldRules(std::string_view token) -> base::Result<std::vector<FieldRule>>
{
...
auto
ParseFieldParts(const std::vector<std::string>& parts) -> base::Result<FieldDef>
{
...
auto
ParseMessageParts(const std::vector<std::string>& parts) -> base::Result<MessageDef>
{
...
auto
ParseGroupParts(const std::vector<std::string>& parts) -> base::Result<GroupDef>
{
...
auto
LoadFileLines(const std::filesystem::path& path) -> base::Result<std::vector<std::string>>
{
...
auto
ParseDictionaryLines(const std::vector<std::string>& lines) -> base::Result<NormalizedDictionary>
{
...
auto
ParseDictionary(const std::filesystem::path& path) -> base::Result<NormalizedDictionary>
{
