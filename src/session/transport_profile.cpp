...
auto
TransportSessionProfile::Fix41() -> TransportSessionProfile
{
  return TransportSessionProfile{
...
auto
TransportSessionProfile::Fix42() -> TransportSessionProfile
{
  return TransportSessionProfile{
...
auto
TransportSessionProfile::Fix43() -> TransportSessionProfile
{
  return TransportSessionProfile{
...
auto
TransportSessionProfile::Fix44() -> TransportSessionProfile
{
  return TransportSessionProfile{
...
auto
TransportSessionProfile::FixT11() -> TransportSessionProfile
{
  return TransportSessionProfile{
...
auto
TransportSessionProfile::FromBeginString(std::string_view begin_string) -> TransportSessionProfile
{
  if (begin_string == "FIX.4.0")
    return Fix40();
  if (begin_string == "FIX.4.1")
    return Fix41();
  if (begin_string == "FIX.4.2")
    return Fix42();
  if (begin_string == "FIX.4.3")
    return Fix43();
