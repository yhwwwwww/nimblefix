...
auto
MessageHasTag(MessageView message, std::uint32_t tag) -> bool
{
...
auto
MissingRequiredField(std::uint32_t tag, std::uint32_t* missing_tag) -> base::Status
{
...
auto
ValidateRequiredRules(const profile::NormalizedDictionaryView& dictionary,
                      MessageView message,
                      RuleSpan rules,
                      std::uint32_t* missing_tag) -> base::Status;

auto
ValidateRequiredGroup(const profile::NormalizedDictionaryView& dictionary,
                      GroupView group,
...
auto
GroupEntryGetString(MessageView view, std::uint32_t tag) -> std::optional<std::string_view>
{
  return view.get_string(tag);
}

auto
GroupEntryGetInt(MessageView view, std::uint32_t tag) -> std::optional<std::int64_t>
{
  return view.get_int(tag);
}

auto
GroupEntryGetChar(MessageView view, std::uint32_t tag) -> std::optional<char>
{
  return view.get_char(tag);
}

auto
GroupEntryGetFloat(MessageView view, std::uint32_t tag) -> std::optional<double>
{
  return view.get_float(tag);
}

auto
GroupEntryGetBoolean(MessageView view, std::uint32_t tag) -> std::optional<bool>
{
...
auto
TypedMessageView::Bind(const profile::NormalizedDictionaryView& dictionary, MessageView message)
...
auto
TypedMessageView::validate_required_fields(std::uint32_t* missing_tag) const -> base::Status
{
...
auto
TypedMessageView::get_string(std::uint32_t tag) const -> std::optional<std::string_view>
{
  return message_.get_string(tag);
}

auto
TypedMessageView::get_timestamp(std::uint32_t tag) const -> std::optional<std::string_view>
{
...
auto
TypedMessageView::get_int(std::uint32_t tag) const -> std::optional<std::int64_t>
{
  return message_.get_int(tag);
}

auto
TypedMessageView::get_char(std::uint32_t tag) const -> std::optional<char>
{
  return message_.get_char(tag);
}

auto
TypedMessageView::get_float(std::uint32_t tag) const -> std::optional<double>
{
  return message_.get_float(tag);
}

auto
TypedMessageView::get_boolean(std::uint32_t tag) const -> std::optional<bool>
{
  return message_.get_boolean(tag);
}

auto
TypedMessageView::group(std::uint32_t count_tag) const -> std::optional<TypedGroupView>
{
...
auto
TypedGroupEntryView::get_string(std::uint32_t tag) const -> std::optional<std::string_view>
{
  return GroupEntryGetString(entry_, tag);
}

auto
TypedGroupEntryView::get_timestamp(std::uint32_t tag) const -> std::optional<std::string_view>
{
  const auto* field = dictionary_ == nullptr ? nullptr : dictionary_->find_field(tag);
  if (field == nullptr || static_cast<profile::ValueType>(field->value_type) != profile::ValueType::kTimestamp) {
    return std::nullopt;
...
auto
TypedGroupEntryView::get_int(std::uint32_t tag) const -> std::optional<std::int64_t>
{
  return GroupEntryGetInt(entry_, tag);
}

auto
TypedGroupEntryView::get_char(std::uint32_t tag) const -> std::optional<char>
{
  return GroupEntryGetChar(entry_, tag);
}

auto
TypedGroupEntryView::get_float(std::uint32_t tag) const -> std::optional<double>
{
  return GroupEntryGetFloat(entry_, tag);
}

auto
TypedGroupEntryView::get_boolean(std::uint32_t tag) const -> std::optional<bool>
{
  return GroupEntryGetBoolean(entry_, tag);
}

auto
TypedGroupEntryView::group(std::uint32_t count_tag) const -> std::optional<TypedGroupView>
{
  if (dictionary_ == nullptr) {
    return std::nullopt;
  }
...
auto
TypedGroupView::Iterator::operator*() const -> TypedGroupEntryView
{
  return TypedGroupEntryView(dictionary_, group_[index_], group_def_);
}

auto
TypedGroupView::operator[](std::size_t index) const -> TypedGroupEntryView
{
  return TypedGroupEntryView(dictionary_, group_[index], group_def_);
}

auto
TypedGroupView::begin() const -> Iterator
{
  return Iterator(dictionary_, group_, group_def_, 0U);
}

auto
TypedGroupView::end() const -> Iterator
{
