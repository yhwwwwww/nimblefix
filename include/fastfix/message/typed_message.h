...
class TypedMessageView {
  public:
    ...
    [[nodiscard]] static auto FromParts(
        const profile::NormalizedDictionaryView& dictionary,
        MessageView message,
  ...
  private:
    TypedMessageView(
        ...
        : dictionary_(dictionary), message_(message), message_def_(message_def) {
    }
...
class TypedGroupEntryView {
  public:
    ...
    TypedGroupEntryView(
        ...
        : dictionary_(dictionary), entry_(entry), group_def_(group_def) {
    }
...
class TypedGroupView {
  public:
    class Iterator {
      public:
        ...
        Iterator(
            ...
            const profile::GroupDefRecord* group_def,
            std::size_t index)
            : dictionary_(dictionary), group_(group), group_def_(group_def), index_(index) {
        }
        ...
        [[nodiscard]] bool operator==(const Iterator& other) const {
            return dictionary_ == other.dictionary_ && group_def_ == other.group_def_ &&
                index_ == other.index_ && group_.size() == other.group_.size();
        }
    ...
    TypedGroupView(
        ...
        GroupView group,
        const profile::GroupDefRecord* group_def)
        : dictionary_(dictionary), group_(group), group_def_(group_def) {
    }

    [[nodiscard]] bool valid() const {
        return dictionary_ != nullptr && group_.valid() && group_def_ != nullptr;
    }
